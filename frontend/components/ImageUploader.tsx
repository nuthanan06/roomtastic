      ...
      <div className="w-full h-screen flex flex-col">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-900">
          <div className="rounded-lg border border-gray-700 overflow-hidden">
            <div className="px-3 py-2 text-sm text-gray-300 bg-gray-800 border-b border-gray-700">
              Original Image
            </div>
            <Image
              src={processedData.originalImage}
              alt="Original upload"
              width={1280}
              height={720}
              unoptimized
        ...
        <div className="space-y-4">
          ...
          {preview && (
            <div className="relative overflow-hidden rounded-lg border-2 border-gray-600">
              <Image src={preview} alt="Preview" width={1024} height={768} unoptimized className="w-full h-auto" />
            </div>
          )}
